                    ...
                    <div class="col-md-4">
                        <div class="row" id="gallary_img_stats">
                            <div class="col-sm-12 mb-3">
                                ...
                                <input type="url" class="form-control" id="image_url" placeholder="image url" readonly
                                    value="">
                            </div>
                            <div class="col-sm-12 mb-3">
                            ...
                            <div class="col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="dimensions" placeholder="image dimensions"
                                    readonly value="">
                            </div>
